...
public class Sender {
	...
	private String getFile(String fn) throws IOException {
		fn = fn.trim();
		System.out.println("FN2345: " + fn);
		String temp = new String(Files.readAllBytes(Paths.get(fn)));
		System.out.println("HERE1234: " + temp);
	...
	public void sendFile(String fn) throws WrongPacketTypeException, IOException {
		System.out.println("In the sendFile");
		System.out.println("fn: ");
		System.out.println(fn);
		String fileData = getFile(fn);
		System.out.println("File DAT? ");
		System.out.println(fileData);
		int totalBytes = 0; // declare totalBytes
